...
export default function ActualizarActivoModal({ isOpen, onClose }: ActualizarActivoModalProps) {
  return (
    <Modal 
    isOpen={isOpen} 
    onClose={onClose}
      ...
      <ModalContent>
        ...
        <TextContainer>
          <TextGroup>
            ...
            <Text styleName="Body Medium">El registro se actualizara automaticamente</Text>
          </TextGroup>
        </TextContainer>
      </ModalContent>
    </Modal>
