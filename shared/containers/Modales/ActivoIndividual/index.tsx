...
import { StepRenderer } from '@/features/client/AssetFleet/components/StepRenderer'
import ListInformationBasic from '@/features/client/AssetFleet/components/AssetManagementForm/ListInformationBasic'
import ListInformationDetailed from '@/features/client/AssetFleet/components/AssetManagementForm/ListInformationDetailed'
import ListExpirationsAndMaintenance from '@/features/client/AssetFleet/components/AssetManagementForm/ListExpirationsAndMaintenance'
import ListDocumentation from '@/features/client/AssetFleet/components/AssetManagementForm/ListDocumentation'
import {
  ButtonsContainer,
  ActionButton
...
const ActivoModal: React.FC<ActivoModalProps> = ({
  ...
  const handleEditClick = () => {
    ...
    router.push(
      `/admin/flotaActivos/nuevoActivo?edit=true&id=${modalContent.id}`
    )
    onClose()
  }
