        ...
        <BottomBlock>
          <TitleSection>
            <Text styleName="Highligth Standard">
              Referencia para carga de datos
            </Text>
            <Text styleName="Body Medium">
              Verifica la información antes de actualizar la base de datos
            </Text>
          </TitleSection>
          <TableList customColumns={vehicleColumns} data={mockData} columns={[]} />
        </BottomBlock>
      </Container>
    </GeneralContainer>
  );
