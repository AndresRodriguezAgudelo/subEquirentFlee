...
export default function AssetManagementForm({ isEditing = false, initialData }: AssetManagementFormProps) {
    ...
    <FormProvider {...methods}>
      <FormStyle onSubmit={methods.handleSubmit(onSubmit)}>
        <ContainerMandatory>
          ...
          <fieldset>
            ...
            <SwitchInput
              ...
              initialStatus={(methods.watch('state_physical') as 'option1' | 'option2') || 'option1'}
          ...
          <DatePickerInput
            ...
            selected={methods.watch('registration_date') ? new Date(methods.watch('registration_date')) : null}
          />
        ...
        <GroupButtons>
          ...
          <ButtonCancel type="button" onClick={() => setIsConfirmationModalOpen(true)}>
            <Text styleName={'Content Accent'}>Cancelar</Text>
          </ButtonCancel>
          <ButtonSave type="button" onClick={() => setIsCargarDatosModalOpen(true)}>
