...
import TesResponsiveModal from '../../containers/Modales/TesResponsiveModal';
    ...
    <Container>
      ...
      {selectedAsset && (
        <>
          ...
          <ElementosInspeccionContainer>Contenedor 3</ElementosInspeccionContainer>
          <DescripcionNovedadesContainer>Contenedor 4</DescripcionNovedadesContainer>
        </>
      )}
          {/* <BotonesFinalesContainer>
