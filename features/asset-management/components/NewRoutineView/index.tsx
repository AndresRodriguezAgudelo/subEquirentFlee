...
import AddTabs from '../../containers/Modales/AddTabs';
import {
  FormContainer,
  TitleSection,
  TitleContainer,
...
import TabsAssignment from '@/shared/components/TabsAssignment';
...
export default function NewRoutineView() {
  ...
  return (
    ...
    <AddTabs 
      isOpen={isAddTabsOpen}
      onClose={() => setIsAddTabsOpen(false)}
    />
    </>
  );
}
