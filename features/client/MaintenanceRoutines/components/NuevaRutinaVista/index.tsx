...
import AddTabs from '../../../../../shared/containers/Modales/AddTabs'
import {
  FormContainer,
  TitleSection,
  TitleContainer,
...
import TabsAssignment from '@/features/client/MaintenanceRoutines/components/TabsAssignment'
...
export default function NewRoutineView() {
  ...
  const [isAddTabsOpen, setIsAddTabsOpen] = useState(false)
  ...
  const handleInicioVigenciaChange = (
    tipo: 'fechaMatricula' | 'ultimoMantenimiento'
  ) => {
    setFormData(prev => ({
      ...prev,
      inicioVigencia: {
  ...
  return (
    <>
        ...
        <FormContainer>
          ...
          <TitleSection>
            ...
            <ButtonGroup>
              ...
              <Button
                variant={
                  selectedType === 'personalizada' ? 'primary' : 'secondary'
                }
            ...
            <RowInputGroup>
              ...
              <Select
                ...
                onChangeSelect={selected =>
                  setFormData({ ...formData, vigencia: selected.value })
                }
              ...
              <CheckBoxGroup
                ...
                tooltipData="Seleccione cuando inicia la vigencia"
                onChange={selected => {
                  const fechaMatricula = selected.includes('Fecha de Matrícula')
                  const ultimoMantenimiento = selected.includes(
              ...
              <CheckBoxGroup
                ...
                tooltipData="Seleccione la unidad de medida"
                onChange={selected => {
          ...
          <FormSection>
            <TabsAssignment
              label="Componentes de la rutina"
              tooltipData="Lista de trabajos a realizar en la rutina"
              items={[
                'Llantas',
                'Frenos',
                'Espejos',
              ...
              onAddClick={() => setIsAddTabsOpen(true)}
            />
          </FormSection>
          ...
          <FormSection>
            ...
            <SubSectionTitle>
              <Text styleName="Caption Standard">
                Alerta por variable de control
              </Text>
            </SubSectionTitle>
              ...
              <Select
                ...
                onChangeSelect={selected =>
                  setFormData(prev => ({
                    ...prev,
                    alertaKilometraje: {
                      ...prev.alertaKilometraje,
                      inicioAlerta: selected.value
                    }
                  }))
                }
      ...
      <AddTabs isOpen={isAddTabsOpen} onClose={() => setIsAddTabsOpen(false)} />
    </>
  )
}
